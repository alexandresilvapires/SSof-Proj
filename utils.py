...
def track_taint(tree, entry_points, sanitization, sinks, checkImplicit):
    ...
    def get_source_from_var(tainted_vars, var_id):
        ...
        return get_prop_from_var(tainted_vars, var_id, tainted_vars.get_source)

    def get_all_sanitized_flows_from_var(tainted_vars, var_id):
        return get_prop_from_var(tainted_vars, var_id, tainted_vars.get_sanitized_flows)
    ...
    def check_for_tainted_assignments(assignments, tainted_vars, instantiated_vars, tainted_sinks):
        ...
        for assignment in assignments:
            ...
            called_ids = [getCallID(c) for c in calls]
            ...
            tainted_count += sum(1 for v in var_ids if v in tainted_vars.vars or v not in instantiated_vars)
